        ...
        <div class="col-md-6">
            <div class="card card-warning">
                ...
                <div class="card-body" style="display: block;">
                    <form method="POST" action="{{ route('branches.update', $item->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 mb-2">
                                <x-ui.form.text-input name="phone" label="Teléfono" placeholder="Ingrese el teléfono"
                                    icon="fas fa-phone" maxlength="20" :value="old('phone', $item->phone ?? '')" />
                            </div>

                            <div class="form-group col-md-12 mb-2">
                                <x-ui.form.textarea-input name="address" label="Dirección"
                                    placeholder="Ingrese la dirección" icon="fas fa-map-marker-alt" required maxlength="255"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <a href="{{ route('branches.edit', $item->id) }}" class="btn btn-secondary"><i
